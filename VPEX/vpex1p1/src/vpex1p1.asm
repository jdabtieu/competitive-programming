...
_start:
    ...
    mov r12d, 1000              ; r12d = min
    xor r13d, r13d              ; r13d = num1
    xor r14d, r14d              ; r14d = num2
    xor rbx, rbx                ; loop counter
    jmp l1c
l1:
    inc rbx
    call readint                ; readint
    cmp r12d, eax               ; check if int is smallest
    cmovg r12d, eax             ; move to r12d if it is
    add r13d, eax               ; add to sum
l1c:
    cmp rbx, 4
    jl l1

    call readint
    cmp eax, r12d               ; check if 5th int is smallest
    jle l1d
    sub eax, r12d
    add r13d, eax               ; add 5th if not smallest and subtract smallest
l1d:
    mov r12d, 1000              ; reset min
    xor rbx, rbx                ; reset loop counter
    jmp l2c
l2:
    inc rbx
    call readint                ; readint
...
l2c:
    ...
    jle l2d
    sub eax, r12d
    add r14d, eax               ; add 5th if not smallest and subtract smallest
l2d:
    mov edi, r13d
    cmp edi, r14d
    cmovl edi, r14d
